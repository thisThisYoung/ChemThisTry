...
1. 打开 **Preferences → AI** 标签页；
2. 填入模型服务的 Base URL / API Key / 模型名（需 OpenAI 兼容、**支持 function/tool calling**）；
3. 勾选 **Agent mode**。
...
| Agent 模式开关 UI | `src/components/settings/PreferencesModal.tsx`（AI 标签页） |
